...
% \address[Z. Zhang]{Email addresses: \href{mailto:zzhang54@qub.ac.uk}%
% {zzhang54@qub.ac.uk}}
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.7\textwidth]{figures/q3_ii_states.eps}
%     \caption{states against time}
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.7\textwidth]{figures/q3_ii_control_actions.eps}
%     \caption{control actions against time}
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.7\textwidth]{figures/q4_i_states.eps}
%     \caption{$x_t$ against $t$}
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.7\textwidth]{figures/q4_i_control_actions.eps}
%     \caption{$u_t$ against $t$}
